...
<pre>
% bin/plugin -url https://oss-es-plugins.s3.amazonaws.com/elasticsearch-zookeeper/elasticsearch-zookeeper-0.20.0.zip -install elasticsearch-zookeeper-0.20.0
</pre>
